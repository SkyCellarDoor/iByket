...
(function ($, window, document, undefined) {
                        ...
                        calendar: function () {
                            ...
                            for (p = 0; p < pages; p++) {
                                ...
                                if (!isTimeOnly) {
                                    ...
                                    var th_left = $('<th/>').addClass(className.prevIcon).appendTo(row);
                                    cell = $('<th/ nowrap>').attr('colspan', '' + columns - 2).appendTo(row);
                                    var th_right = $('<th/>').addClass(className.prevIcon).appendTo(row);
                                    ...
                                    if (p === 0) {
                                        ...
                                        var prev = $('<span/>').addClass(className.prev).appendTo(th_left);
                                    ...
                                    if (p === pages - 1) {
                                        var next = $('<span/>').addClass(className.next).appendTo(th_right);
    ...
    $.fn.calendar.settings = {
        ...
        className: {
            ...
            prev: 'prev link',
            next: 'next link',
            prevIcon: 'left arrow icon',
            nextIcon: 'right arrow icon',
            link: 'link',
            cell: 'link',
