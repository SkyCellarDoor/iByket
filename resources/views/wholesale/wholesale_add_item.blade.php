    ...
    <td style="padding: 0px !important;">
        <div class="ui content">
            <div class="ui basic segment">
                    <span id="span_price_{{ $rnd }}" style="margin-right: 25px">{{ $product->one_cost_wholesale_model->cost }}
                        &nbsp;p.</span>
                <div class="ui top right attached tiny label"
                     style="margin-top: -1px !important; margin-right: -1px !important;">{{ $product->one_cost_wholesale_model->cost }}
                    &nbsp;p.
                </div>
            </div>
        </div>
        <input id="price_{{ $rnd }}" name="price[]" data-id="{{ $rnd }}" data-promotion="0" type="hidden"
               value="{{ $product->one_cost_wholesale_model->cost }}" class="price">
        <input id="default_price_{{ $rnd }}" type="hidden" value="{{ $product->one_cost_wholesale_model->cost }}">
    </td>
    <td>
...
{{--<div class="ui content">--}}
{{--<div class="ui basic segment">--}}
{{--<span id="span_price_{{ $rnd }}" style="margin-right: 25px">{{ $product->many_cost_wholesale_model->cost }}--}}
{{--&nbsp;p.</span>--}}
{{--<div class="ui top right attached tiny label"--}}
{{--style="margin-top: -1px !important; margin-right: -1px !important;">{{ $product->many_cost_wholesale_model->cost }}--}}
{{--&nbsp;p.--}}
{{--</div>--}}
{{--</div>--}}
{{--</div>--}}
{{--<input id="price_{{ $rnd }}" name="price[]" data-id="{{ $rnd }}" data-promotion="0" type="hidden"--}}
{{--value="{{ $product->many_cost_wholesale_model->cost }}" class="price">--}}
{{--<input id="default_price_{{ $rnd }}" type="hidden" value="{{ $product->many_cost_wholesale_model->cost }}">--}}
{{--</td>--}}
{{--<td>--}}
{{--<span id="span_sum_{{ $rnd }}">0.00&nbsp;p.</span>--}}
{{--<input id="sum_{{ $rnd }}" class="sum" type="hidden" value="">--}}
